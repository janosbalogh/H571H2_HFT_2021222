    ...
    public class SteamDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Company>().HasData(new Company[]
            {
                ...
                new Company("1#Valve#Gabe Newell#USA#360"),
                new Company("2#KRAFTON, Inc.#Kim Chang-han#South Korea#2100"),
                new Company("3#Facepunch Studios#Garry Newman#UK#20"),
                new Company("4#Psyonix LLC#Dave Hagewood#USA#189"),
                new Company("5#Ubisoft Montreal#Yannis Mallat#Canada#2300"),
                new Company("6#Bohemia Interactive#Marek Spanel#Czech Republic#300"),
                new Company("7#Studio Wildcard#Doug Kennedy#USA#35"),
                new Company("8#Rockstar North#Andrew Semple#UK#650"),
                new Company("9#Bethesda Game Studios#Ashley Cheng#USA#420"),
                new Company("10#Behaviour Interactive Inc.#Remi Racine#Canada#850"),
                new Company("11#Bungie#Pete Parsons#USA#900"),
                new Company("12#CAPCOM Co., Ltd.#Kenzo Tsujimoto#Japan#2832"),
                new Company("13#Digital Extremes#James Schmalz#Canada#300"),
                new Company("14#Grinding Gear Games#Chris Wilson#New Zealand#120"),
                new Company("15#Amazon Games#Christoph Hartmann#USA#2000"),
                new Company("16#NetEase Games#Ding Lei#China#200"),
                new Company("17#SCS Software#Pavel Sebor#Czech Republic#170"),
                new Company("18#OVERKILL - a Starbreeze Studio.#Tobias Sjorgen#Sweden#180"),
                new Company("19#The Fun Pimps#CHRISTIAN LANG#USA#20"),
                new Company("20#Re-Logic#Andrew Spinks#USA#12"),
                new Company("21#Firaxis Games#Steve Martin#USA#180"),
                new Company("22#Respawn Entertainment#Vince Zampella#USA#315"),
                new Company("23#TaleWorlds Entertainment#Armagan Yavuz#Turkey#131"),
                new Company("24#FromSoftware Inc.#Hidetaka Miyazaki#Japan#332"),
                new Company("25#Visual Concepts#Greg Thomas#USA#350"),
                new Company("26#Smartly Dressed Games#Nelson Sexton#Canada#2"),
                new Company("27#Massive Entertainment#Thomas Andren#Sweden#650"),
                new Company("28#Gaijin Entertainment#Anton Yudintsev#Hungary#200"),
                new Company("29#Wargaming Group Limited#Victor Kislyi#Cyprus#1750"),
                new Company("30#Crate Entertainment#Arthur Bruno#USA#13"),
                new Company("31#CD PROJEKT RED#Adam Kicinski#Poland#1111"),
                new Company("32#ConcernedApe#Eric Barone#USA#1"),
                new Company("33#GuiGu Studio#Huang Zhenlong#China#100"),
                new Company("34#Titan Forge Games#Erez Goren#USA#450"),
                new Company("35#Wallpaper Engine Team#Kristjan Skutta#Germany#2"),
                new Company("36#Gearbox Software#Steve Jones#USA#1300"),
                new Company("37#Hello Games#Sean Murray#UK#26"),
                new Company("38#Colossal Order Ltd.#Mariina Hallikainen#Finland#17"),
            ...
            {
                //new Game("appid#style#name#developer#positive#negative#average_forever#average_2weeks#price#initialprice#ccu"),
